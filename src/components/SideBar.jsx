  ...
  return (
    ...
    <div className='sidebar'>
        ...
        <div style={{display:"grid"}}>
            <Link to="/home" className='sidebar-link'><FaHome className='icon-sidebar'/>Página Inicial </Link>
            <Link to="/materias" className='sidebar-link'><FaBook className='icon-sidebar'/>Matérias</Link>
        </div>
